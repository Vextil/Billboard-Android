...
public class TeatroEstrenosFragment extends ProgressFragment
{
    public TeatroEstrenosFragment() {}

    public static Fragment newInstance(Integer color, String title)
    {
        Fragment fragment = new TeatroEstrenosFragment();
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        setEmptyText(R.string.teatro_estrenos_error);
    ...
    {
        if (!isPaused()) {
            App.API().getTeatroEstrenos(new Callback<FuncionesService>() {
                @Override
