...
public class InfantilesCarteleraFragment extends ProgressFragment
{

    public InfantilesCarteleraFragment() { }

    public static Fragment newInstance(Integer color, String title)
    {
        Fragment fragment = new InfantilesCarteleraFragment();
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        setEmptyText(R.string.infantiles_cartelera_error);
    ...
    {
       /* if (!isPaused()) {
            App.API().getInfantilesCartelera(new Callback<Funciones>() {
                @Override
