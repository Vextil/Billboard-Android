...
import com.siercuit.cartelera.adapters.TeatroFuncionesAdapter;
...
public class TeatroCarteleraFragment extends ProgressFragment
{
    public TeatroCarteleraFragment() { }

    public static Fragment newInstance(Integer color, String title)
    {
        Fragment fragment = new TeatroCarteleraFragment();
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        setEmptyText(R.string.teatro_cartelera_error);
    ...
    {
        if (!isPaused()) {
            App.API().getTeatroCartelera(new Callback<FuncionesService>() {
                @Override
    ...
    public void viewBuilder()
    {
        ...
        TeatroFuncionesAdapter adapter = new TeatroFuncionesAdapter(getActivity(), data);
