...
public abstract class ListAsGridAdapter extends BaseAdapter {
    ...
    private GridItemClickInterface mGridItemClickInterface;
    ...
    public final void setOnGridClickListener(GridItemClickInterface listener) {
        mGridItemClickInterface = listener;
    }

    private final void onGridItemClicked(View v, int position) {
        if (mGridItemClickInterface != null) {
            mGridItemClickInterface.onGridItemClicked(v, position, getItemId(position));
        }
    }
